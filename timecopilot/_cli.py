...
class TimeCopilot:
    ...
    def forecast(
        ...
        with (
            self.console.status(
                "[bold blue]OAB-forecast is navigating through time...[/bold blue]"
            ),
...
class InteractiveChat:
    """Simplified interactive chat for OAB-forecast."""
    ...
    def _print_welcome(self):
        ...
        welcome_text = """
# 👋 Hi there! I'm OAB-forecast, the GenAI Forecasting Agent!
...
Ready to dive into your data? Just tell me what you'd like to explore! 🚀
        ...
        panel = Panel(
            ...
            title="[bold blue]Welcome to OAB-forecast[/bold blue]",
            border_style="blue",
            padding=(1, 2),
        )
    ...
    async def _handle_command(self, user_input: str) -> bool:
        ...
        if self.agent and self.agent.is_queryable():
            ...
            try:
                with (
                    Status(
                        "[bold blue]OAB-forecast is thinking...[/bold blue]",
                ...
                response_panel = Panel(
                    result.output,
                    title="[bold cyan]OAB-forecast Response[/bold cyan]",
                    border_style="cyan",
                    padding=(1, 2),
                )
    ...
    async def run(self):
        ...
        try:
            while True:
                try:
                    user_input = Prompt.ask(
                        "\n[bold blue]OAB-forecast[/bold blue]", default=""
                    )
            ...
            self.console.print(
                "\n[bold blue]👋 Thanks for using OAB-forecast! "
...
app = typer.Typer(
    name="oabforecast",
    help="OAB-forecast - Your GenAI Forecasting Agent",
...
def main_callback(
    ...
    """
    OAB-forecast - Your GenAI Forecasting Agent

    Just run 'oabforecast' to start chatting with your AI forecasting companion!
...
def forecast_command(
    path: str = typer.Argument(..., help="Path to CSV or Parquet file or URL"),
    llm: str = typer.Option(
